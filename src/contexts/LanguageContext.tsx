...
const translations = {
  es: {
    ...
    portfolioDescription: 'Soy una diseñadora y desarrolladora apasionada por crear experiencias digitales únicas y funcionales.',
    viewMore: 'Ver más proyectos',
    myProjects: 'Mis Trabajos',
    
    // Services
    servicesDescription: 'Ofrecemos diferentes soluciones adaptadas a tus necesidades específicas',
    
    // Landing Page Service
    landingPage: 'Landing Page',
    fromPrice: 'Desde {price}',
    landingPageDescription: 'Causa una gran primera impresión con una página moderna, atractiva y perfectamente diseñada para resaltar tu presencia online. Creamos experiencias digitales únicas que capturan la atención y generan un impacto duradero.',
    ...
    corporateWebDescription: 'Haz que tu empresa se destaque de la competencia con una web profesional, impactante y diseñada para atraer confianza. Diseñamos plataformas visualmente atractivas que presentan productos o servicios de manera clara, resaltando lo mejor de tu negocio y destacando tu identidad en el mundo digital.',
    ...
    customSoftwareDescription: 'Soluciones digitales diseñadas exclusivamente para tu negocio. Optimiza procesos, ahorra tiempo y potencia tu crecimiento. Desarrollamos herramientas a la medida de tus necesidades, que se adaptan perfectamente a tus operaciones y mejoran la eficiencia de tu empresa.',
    ...
    customSoftwareFeature3: 'Desarrollo de software con funcionalidades avanzadas',
    ...
    workProcessDescription: 'Nuestro proceso está diseñado para asegurar resultados excepcionales',
    
    // Work Process Steps
    workProcessStep1Title: 'Concepto y Presupuesto',
    workProcessStep1Description: 'Discutimos las primeras ideas durante una breve reunión, donde definimos el alcance del proyecto de acuerdo a tus necesidades, preferencias y presupuesto.',
    workProcessStep2Title: 'Propuesta de Diseño',
    workProcessStep2Description: 'Estudiamos tu empresa y luego te presentamos una idea de diseño profesional y apropiada para tu negocio.',
    workProcessStep3Title: 'Diseño y desarrollo',
    workProcessStep3Description: 'Una vez que definimos tu diseño, comenzamos a trabajar en la creación de tu sitio web.',
    workProcessStep4Title: 'Revisión y acabado de Diseño',
    workProcessStep4Description: 'Realizamos los cambios finales y procesamos el contenido definitivo, incluyendo textos y fotos.',
    workProcessStep5Title: 'Fin del Proyecto',
    workProcessStep5Description: 'Lanzamos tu sitio web al mundo digital, garantizando que cada detalle esté perfectamente configurado y optimizado para ofrecer un rendimiento excepcional y una presencia online destacada.',
    
    // Satisfaction Guarantee
    satisfactionGuarantee: 'Garantía de Satisfacción',
    satisfactionGuaranteeDescription: 'Entendemos que la decisión de invertir en una página web es importante. Es normal sentir cierta inquietud sobre el resultado final. Por eso, te ofrecemos lo siguiente:',
    satisfactionFeature1: 'Pago del 50% al inicio y el resto cuando la web esté terminada',
    satisfactionFeature2: 'Revisión de la web antes de pagar el saldo',
    satisfactionFeature3: '90 días de soporte técnico incluido después de la entrega',
  ...
  en: {
    ...
    portfolioDescription: 'I am a designer and developer passionate about creating unique and functional digital experiences.',
    viewMore: 'View more projects',
    myProjects: 'My Projects',
    
    // Services
    servicesDescription: 'We offer different solutions tailored to your specific needs',
    
    // Landing Page Service
    landingPage: 'Landing Page',
    fromPrice: 'From {price}',
    landingPageDescription: 'Make a great first impression with a modern, attractive page perfectly designed to highlight your online presence. We create unique digital experiences that capture attention and generate a lasting impact.',
    ...
    corporateWebDescription: 'Make your company stand out from the competition with a professional, impactful website designed to attract trust. We design visually attractive platforms that present products or services clearly, highlighting the best of your business and enhancing your identity in the digital world.',
    ...
    customSoftwareDescription: 'Digital solutions designed exclusively for your business. Optimize processes, save time and boost your growth. We develop tools tailored to your needs, which perfectly adapt to your operations and improve the efficiency of your company.',
    ...
    workProcessDescription: 'Our process is designed to ensure exceptional results',
    
    // Work Process Steps
    workProcessStep1Title: 'Concept and Budget',
    workProcessStep1Description: 'We discuss the initial ideas during a brief meeting, where we define the scope of the project according to your needs, preferences and budget.',
    workProcessStep2Title: 'Design Proposal',
    workProcessStep2Description: 'We study your company and then present you with a professional design idea appropriate for your business.',
    workProcessStep3Title: 'Design and Development',
    workProcessStep3Description: 'Once we define your design, we begin working on creating your website.',
    workProcessStep4Title: 'Design Review and Finalization',
    workProcessStep4Description: 'We make the final changes and process the definitive content, including texts and photos.',
    workProcessStep5Title: 'Project Completion',
    workProcessStep5Description: 'We launch your website to the digital world, ensuring that every detail is perfectly configured and optimized to offer exceptional performance and a prominent online presence.',
    
    // Satisfaction Guarantee
    satisfactionGuarantee: 'Satisfaction Guarantee',
    satisfactionGuaranteeDescription: 'We understand that the decision to invest in a website is important. It\'s normal to feel some concern about the final result. Therefore, we offer you the following:',
    satisfactionFeature1: '50% payment at the start and the rest when the website is finished',
    satisfactionFeature2: 'Review of the website before paying the balance',
    satisfactionFeature3: '90 days of technical support included after delivery',
  ...
  ca: {
    ...
    portfolioDescription: 'Soc una dissenyadora i desenvolupadora apassionada per crear experiències digitals úniques i funcionals.',
    viewMore: 'Veure més projectes',
    myProjects: 'Els Meus Treballs',
    
    // Services
    servicesDescription: 'Oferim diferents solucions adaptades a les teves necessitats específiques',
    
    // Landing Page Service
    landingPage: 'Landing Page',
    fromPrice: 'Des de {price}',
    landingPageDescription: 'Causa una gran primera impressió amb una pàgina moderna, atractiva i perfectament dissenyada per destacar la teva presència en línia. Creem experiències digitals úniques que capturen l\'atenció i generen un impacte durador.',
    ...
    // Corporate Web Service
    corporateWeb: 'Web corporativa',
    corporateWebDescription: 'Fes que la teva empresa destaqui de la competència amb una web professional, impactant i dissenyada per atraure confiança. Dissenyem plataformes visualment atractives que presenten productes o serveis de manera clara, ressaltant el millor del teu negoci i destacant la teva identitat en el món digital.',
    ...
    customSoftwareDescription: 'Solucions digitals dissenyades exclusivament per al teu negoci. Optimitza processos, estalvia temps i potencia el teu creixement. Desenvolupem eines a la mida de les teves necessitats, que s\'adapten perfectament a les teves operacions i milloren l\'eficiència de la teva empresa.',
    ...
    customSoftwareFeature3: 'Desenvolupament de software amb funcionalitats avançades',
    ...
    workProcessDescription: 'El nostre procés està dissenyat per assegurar resultats excepcionals',
    
    // Work Process Steps
    workProcessStep1Title: 'Concepte i Pressupost',
    workProcessStep1Description: 'Discutim les primeres idees durant una breu reunió, on definim l\'abast del projecte d\'acord a les teves necessitats, preferències i pressupost.',
    workProcessStep2Title: 'Proposta de Disseny',
    workProcessStep2Description: 'Estudiem la teva empresa i després et presentem una idea de disseny professional i apropiada per al teu negoci.',
    workProcessStep3Title: 'Disseny i desenvolupament',
    workProcessStep3Description: 'Una vegada que definim el teu disseny, comencem a treballar en la creació del teu lloc web.',
    workProcessStep4Title: 'Revisió i acabat de Disseny',
    workProcessStep4Description: 'Realitzem els canvis finals i processem el contingut definitiu, incloent textos i fotos.',
    workProcessStep5Title: 'Fi del Projecte',
    workProcessStep5Description: 'Llancem el teu lloc web al món digital, garantint que cada detall estigui perfectament configurat i optimitzat per oferir un rendiment excepcional i una presència en línia destacada.',
    
    // Satisfaction Guarantee
    satisfactionGuarantee: 'Garantia de Satisfacció',
    satisfactionGuaranteeDescription: 'Entenem que la decisió d\'invertir en una pàgina web és important. És normal sentir certa inquietud sobre el resultat final. Per això, t\'oferim el següent:',
    satisfactionFeature1: 'Pagament del 50% a l\'inici i la resta quan la web estigui acabada',
    satisfactionFeature2: 'Revisió de la web abans de pagar el saldo',
    satisfactionFeature3: '90 dies de suport tècnic inclòs després del lliurament',
  ...
  fr: {
    ...
    portfolioDescription: 'Je suis une designer et développeuse passionnée par la création d\'expériences numériques uniques et fonctionnelles.',
    viewMore: 'Voir plus de projets',
    myProjects: 'Mes Travaux',
    
    // Services
    servicesDescription: 'Nous proposons différentes solutions adaptées à vos besoins spécifiques',
    
    // Landing Page Service
    landingPage: 'Landing Page',
    fromPrice: 'À partir de {price}',
    landingPageDescription: 'Faites une excellente première impression avec une page moderne, attrayante et parfaitement conçue pour mettre en valeur votre présence en ligne. Nous créons des expériences numériques uniques qui captent l\'attention et génèrent un impact durable.',
    landingPageFeature1: '1 page',
    ...
    customSoftwareDescription: 'Solutions numériques conçues exclusivement pour votre entreprise. Optimisez les processus, économisez du temps et stimulez votre croissance. Nous développons des outils adaptés à vos besoins, qui s\'intègrent parfaitement à vos opérations et améliorent l\'efficacité de votre entreprise.',
    ...
    customSoftwareFeature3: 'Développement de logiciels avec fonctionnalités avancées',
    ...
    workProcessDescription: 'Notre processus est conçu pour assurer des résultats exceptionnels',
    
    // Work Process Steps
    workProcessStep1Title: 'Concept et Budget',
    workProcessStep1Description: 'Nous discutons des premières idées lors d\'une brève réunion, où nous définissons la portée du projet en fonction de vos besoins, préférences et budget.',
    workProcessStep2Title: 'Proposition de Design',
    workProcessStep2Description: 'Nous étudions votre entreprise puis vous présentons une idée de design professionnelle et appropriée pour votre entreprise.',
    workProcessStep3Title: 'Design et développement',
    workProcessStep3Description: 'Une fois que nous avons défini votre design, nous commençons à travailler sur la création de votre site web.',
    workProcessStep4Title: 'Révision et finalisation du Design',
    workProcessStep4Description: 'Nous effectuons les changements finaux et traitons le contenu définitif, y compris les textes et les photos.',
    workProcessStep5Title: 'Fin du Projet',
    workProcessStep5Description: 'Nous lançons votre site web dans le monde numérique, en garantissant que chaque détail est parfaitement configuré et optimisé pour offrir des performances exceptionnelles et une présence en ligne remarquable.',
    
    // Satisfaction Guarantee
    satisfactionGuarantee: 'Garantie de Satisfaction',
    satisfactionGuaranteeDescription: 'Nous comprenons que la décision d\'investir dans un site web est importante. Il est normal de ressentir une certaine inquiétude quant au résultat final. C\'est pourquoi nous vous proposons ce qui suit:',
    satisfactionFeature1: 'Paiement de 50% au début et le reste lorsque le site est terminé',
    satisfactionFeature2: 'Révision du site avant de payer le solde',
    satisfactionFeature3: '90 jours de support technique inclus après la livraison',
