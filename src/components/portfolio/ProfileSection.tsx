...
const ProfileSection = () => {
  ...
  return (
    <div className="mb-24 pt-8 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6 md:pr-10 animate-slide-in">
          <h3 className="text-2xl font-display font-bold text-portfolio-purple">{t("designerDeveloper") || "Diseñadora & Desarrolladora"}</h3>
          <p className="text-lg">{t("portfolioDescription") || "Portfolio description"}</p>
