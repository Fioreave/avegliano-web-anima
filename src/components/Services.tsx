...
const Services = () => {
  ...
  const services = [
    {
      ...
      title: t("landingPage"),
      price: t("fromPrice", { price: "350 EUR" }),
      features: [
    ...
    },
    {
      ...
      price: t("fromPrice", { price: "800 EUR" }),
      features: [
    ...
    {
      icon: <ShoppingCart className="h-8 w-8 text-portfolio-purple" />,
      title: t("portfolio"),
      price: t("fromPrice", { price: "1200 EUR" }),
      features: [
        t("portfolioFeature1"),
        t("portfolioFeature2"),
        t("portfolioFeature3"),
  ...
  return (
    <section
      id="services"
      className="py-20 bg-accent/30 dark:bg-portfolio-deep-blue/50"
    >
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="p-6">
                ...
                <p className="text-portfolio-purple font-semibold text-lg mb-4 text-center">
                  {service.price}
                </p>
                <p className="text-sm text-portfolio-deep-blue/80 dark:text-white/70 mb-6">
                  {service.description}
                </p>
                ...
                <ul className="space-y-3 mb-6">
                  {service.features.map((feature, idx) => (
                    <li key={idx} className="flex items-start text-sm">
                      ...
                      <span className="text-portfolio-deep-blue/80 dark:text-white/70">
                        {feature}
                      </span>
                    </li>
                  ))}
                ...
                <Button className="w-full bg-portfolio-purple hover:bg-portfolio-dark-purple text-white flex items-center justify-center gap-2">
                  {t("requestQuote")}
